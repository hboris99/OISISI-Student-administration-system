...
public class StudentValidationActionListener implements ActionListener {
	...
	public StudentValidationActionListener(JButton btn, ArrayList<JTextField> listTxt, boolean[] b) {
		super();
		this.btn = btn;
		txt = listTxt;
		this.b = b;
